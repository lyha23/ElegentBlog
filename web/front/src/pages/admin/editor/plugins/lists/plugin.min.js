...
!(function (u) {
  ...
  var e,
      ...
      return (
        ...
        (function (e, n) {
          for (var t = 0; t < e.length - 1; t++)
            (r = e[t].item), (o = 'list-style-type'), (i = 'none'), (a = r.dom()), ln(a, o, i);
          var r, o, i, a;
          M(e).each(function (e) {
            fn(e.list, n.listAttributes), fn(e.item, n.itemAttributes), Be(e.item, n.content);
          });
        })(o, t),
        (r = o),
        Oe(M(n), I(r), gn),
            ...
            E(R(n.slice(0, t)), i, a)
              ...
              .fold(
                function () {
                  var e;
                  r.dirty &&
                    ((e = r).listAttributes = cn(e.listAttributes, function (e, n) {
                      return 'start' !== n;
                    }));
                },
                function (e) {
    ...
    Yn = function (f, d, l) {
      ...
      if ('false' !== p.getContentEditable(f.selection.getNode())) {
        ...
        Ue.each(
          (function (t, e, r) {
            for (
              var o, i = [], a = t.dom, n = zn(t, e, !0, r), u = zn(t, e, !1, r), s = [], c = n;
              c && (s.push(c), c !== u);
              c = c.nextSibling
            );
            return (
              Ue.each(s, function (e) {
                ...
                if (a.isBlock(e) || Qe(e)) return Qe(e) && a.remove(e), void (o = null);
                var n = e.nextSibling;
    ...
    ot = function (e, n, t, r) {
      ...
      for (
        t &&
        ((u = e.dom),
        Qe((s = o)) && u.isBlock(s.nextSibling) && !Qe(s.previousSibling) && c.next());
        (o = c[t ? 'next' : 'prev2']());
  ...
  !(function gt() {
    c.add('lists', function (e) {
      ...
      return (
        !1 ==
          !(!/(^|[ ,])rtc([, ]|$)/.test(e.getParam('plugins', '', 'string')) || !c.get('rtc')) &&
          (pt(e),
