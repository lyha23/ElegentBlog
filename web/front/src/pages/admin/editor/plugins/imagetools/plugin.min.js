...
!(function (p) {
  ...
  function B(e, n) {
    return e.toCanvas().then(function (t) {
      return (function a(t, e, n) {
        ...
        return o.translate(i, u), o.rotate((n * Math.PI) / 180), o.drawImage(t, 0, 0), M(r, e);
      })(t, e.getType(), n);
    });
  }
  function D(e, n) {
  ...
  var at = function (t, e, n) {
    ...
    gt = function (t, e) {
      return (
        -1 !== d.inArray(t.getParam('imagetools_cors_hosts', [], 'string[]'), new W(e.src).host)
      );
    },
    pt = function (t, e) {
      var n,
    ...
    r.add('imagetools', function (t) {
      ...
      (n = t),
        ...
        (u = t).on('NodeChange', function (t) {
          var e = c.get();
          e && e.src !== t.element.src && (wt(a), u.editorUpload.uploadImagesAuto(), c.set(null)),
