...
!(function (y) {
      ...
      var r = e.split(/\n\n/),
        o = (function (e, t) {
          var n,
            ...
            o = '<' + e;
          if ('object' == typeof t) {
            for (n in t) t.hasOwnProperty(n) && r.push(n + '="' + F.encodeAllRaw(t[n]) + '"');
            r.length && (o += ' ' + r.join(' '));
          }
          return o + '>';
        })(t, n),
  ...
  function V(e) {
    ...
    function t(e, t, n) {
      ...
      r !== s && (a = r < s ? a && a.parent.parent : ((i = a), null)),
        a && a.name === t
          ? a.append(e)
          : ((i = i || a), (a = new $(t, 1)), 1 < n && a.attr('start', '' + n), e.wrap(a)),
        (e.name = 'li'),
    ...
    return (
      I.each(e, function (e, t) {
        ...
        0 !== t.indexOf('mso-comment')
          ? 0 !== t.indexOf('mso-') && ('all' === D(n) || (r && r[t])) && (s[t] = e)
          : o.remove();
      }),
      /(bold)/i.test(s['font-weight']) && (delete s['font-weight'], o.wrap(new $('b', 1))),
      /(italic)/i.test(s['font-style']) && (delete s['font-style'], o.wrap(new $('i', 1))),
  ...
  var X = function (e, t) {
    ...
    Y = function (e, t, n, r) {
      var o,
        ...
        v =
          ...
          (a = n),
          (i = r),
          e.fire('PastePreProcess', { content: o, internal: a, wordContent: i })),
        h = (function (e, t) {
          var n = M({}, e.schema);
    ...
    oe = function (e, t, n, r) {
      var o,
        ...
        s,
        u,
        l = ((o = e), (i = n), (s = U((a = t))), (u = s ? X(o, a) : a), Y(o, u, i, s));
      ...
      var n,
        ...
        m =
          e.getParam('images_reuse_filename') && t.blob.name
            ? ((o = e),
              (a = t.blob.name),
              (i = a.match(/([\s\S]+?)\.(?:jpeg|jpg|png|gif)$/i)) ? o.dom.encode(i[1]) : null)
            : d,
        p = new y.Image();
      if (((p.src = t.uri), (s = p), !(u = e.getParam('images_dataimg_filter')) || u(s))) {
    ...
    pe = function (s, u, l) {
      ...
      function d(e, t, n, r) {
        ...
        ue(e, 'text/html')
          ? (o = e['text/html'])
          : ((o = u.getHtml()), (r = r || A(o)), u.isDefaultContent(o) && (n = !0)),
          (o = z(o)),
          u.remove();
        var a =
            !1 === r &&
      ...
      s.on('keydown', function (e) {
        ...
        if (me(e) && !e.isDefaultPrevented()) {
          ...
          if (
            ...
            return e.preventDefault(), (n = !0), void s.fire('paste', { ieFake: n });
          u.remove(),
            u.create(),
            s.once('keyup', t),
      ...
      s.on('paste', function (e) {
        ...
        e.isDefaultPrevented() ||
          ((n = e.clipboardData),
          -1 !== y.navigator.userAgent.indexOf('Android') && n && n.items && 0 === n.items.length))
          ? u.remove()
          ...
          ? (r || e.preventDefault(),
            ...
            ue(o, 'text/html')
              ? (e.preventDefault(), (i = i || A(o['text/html'])), d(o, r, a, i))
              : w.setEditorTimeout(
                  s,
                  function () {
                    d(o, r, a, i);
      ...
      return {
        create: function () {
          return (function (e, t, n) {
            ...
            (P.ie || P.gecko) &&
              r.setStyle(a, 'left', 'rtl' === r.getStyle(o, 'direction', !0) ? 65535 : -65535),
    ...
    we = function (e, t, n) {
      if (((r = e), !1 !== P.iOS || 'function' != typeof (null == r ? void 0 : r.setData)))
        return !1;
      try {
        return (
          e.clearData(), e.setData('text/html', t), e.setData('text/plain', n), e.setData(O, t), !0
        );
      } catch (o) {
        return !1;
      }
      ...
      i.getParam('paste_block_drop', !1) &&
        ...
        i.on('drop', function (e) {
          ...
          if (!e.isDefaultPrevented() && !u.get()) {
            ...
            if (
              (s.hasHtmlOrText(r) && (!(n = r['text/plain']) || 0 !== n.indexOf('file://'))) ||
  ...
  function Ee(e, t, n, r) {
    ...
    if (!1 === e.getParam('paste_remove_styles_if_webkit', !0) || 'all' === o) return t;
    if ((o && (l = o.split(/[, ]/)), l)) {
      var c = e.dom,
      ...
      t = t.replace(/(<[^>]+) style="([^"]*)"([^>]*>)/gi, function (e, t, n, r) {
        ...
        for (var i = 0; i < l.length; i++) {
          ...
          /color/.test(l[i]) && ((s = c.toHex(s)), (u = c.toHex(u))), u !== s && (a[l[i]] = s);
        }
