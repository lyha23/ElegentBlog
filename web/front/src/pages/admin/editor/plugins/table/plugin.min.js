...
!(function (h) {
  ...
  var e,
    ...
    z = function (n) {
      for (var e = [], t = 0, r = n.length; t < r; ++t) {
        if (!p(n[t])) throw new Error('Arr.flatten item ' + t + ' was not an array, input: ' + n);
        A.apply(e, n[t]);
      }
      return e;
    },
    ...
    cn = function (n, e, t) {
      if (!(m(t) || v(t) || R(t)))
        throw (
          (h.console.error('Invalid call to Attr.set. Key ', e, ':: Value ', t, ':: Element ', n),
    ...
    Un = [
      ...
      { name: 'ChromeOS', search: qn('cros'), versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/] },
    ],
            ...
            for (
              var t,
                ...
                u =
                  ...
                  (r = n.rowspan()),
                  (o = n.colspan()),
                  { element: b(t), rowspan: b(r), colspan: b(o), row: b(f), column: b(e) }),
                i = 0;
              i < n.colspan();
              i++
            )
          ...
          K(t.access, function (n) {
            if (u(n)) {
              var e = n.row(),
                ...
                r = n.column(),
                o = r + n.colspan() - 1;
              e < i ? (i = e) : a < t && (a = t), r < c ? (c = r) : l < o && (l = o);
            }
          }),
      ...
      return Zn(l, f)
        ...
        : Zt(l).bind(function (a) {
            return Zt(f).bind(function (u) {
              ...
              if (ee(u, a)) {
                var e,
                  t = 0 < (e = Le(l, 'td,th', d(u))).length ? e[e.length - 1] : l;
              ...
              return Yt(Jt, l, f, r)
                ...
                .bind(function (n) {
                  return Ge(n, 'table', s).bind(function (n) {
                    ...
                    return S.some({ boxes: qt(n, l, a, f, u), start: o, finish: t });
                  });
                });
              var r, o, i, c;
            });
      ...
      return tr(r, n, e).bind(function (i) {
        ...
        return e.bind(function (u) {
          return t.bind(function (n) {
            return Zn(u, n)
              ? ((e = i.table()), (t = i.first()), (r = i.last()), (o = Vt(e)), zt(o, t, r))
              : S.none();
            var e, t, r, o;
          });
        });
    ...
    Rr = function (m, n, g, p) {
      m.on('BeforeGetContent', function (t) {
        ...
        m.on('BeforeSetContent', function (d) {
          !0 === d.selection &&
            !0 === d.paste &&
            S.from(m.dom.getParent(m.selection.getStart(), 'th,td')).each(function (n) {
              var s = Sn.fromDom(n);
              ct(s).each(function (e) {
                ...
                if (1 === c.length && ((i = c[0]), 'table' === Q(i))) {
                  ...
                  var a = Sn.fromDom(m.getDoc()),
                    l = Mt(a),
                    f = ((o = s), (u = c[0]), { element: b(o), clipboard: b(u), generators: b(l) });
  ...
  var Mr = Er('height', function (n) {
    ...
    ou = function (n) {
      ...
      return (
        ...
        (o = n.clientX),
        (u = n.clientY),
        { target: b(e), x: b(o), y: b(u), stop: c, prevent: a, kill: l, raw: b(n) }
      );
    },
    ...
    du = function (n, e) {
      return (o = e), (u = fu((t = n), (r = 'class')).concat([o])), an(t, r, u.join(' ')), !0;
      var t, r, o, u;
    },
    mu = function (n, e) {
      return (
      ...
      sink: function (n, e) {
        var t = (function (n) {
            ...
            an(t, 'role', 'presentation'),
              Ce(t, { position: 'fixed', left: '0px', top: '0px', width: '100%', height: '100%' }),
              gu(t, bu('blocker')),
              gu(t, e.layerClass);
            return {
              element: function () {
  ...
  var Bu = function (e, t, n) {
        ...
        t.get().each(function (r) {
          i.each(function (t) {
            n(r, 'data-row').each(function (n) {
              var e = c(r, 'top');
              mn(r, 'data-initial-top'), m.trigger.adjustHeight(t, e, parseInt(n, 10));
            }),
              n(r, 'data-column').each(function (n) {
                var e = c(r, 'left');
                mn(r, 'data-initial-left'), m.trigger.adjustWidth(t, e, parseInt(n, 10));
              }),
              Fu(o, t, u, e);
          });
        });
    ...
    Ku = function (n, p, h) {
      var r = Yr,
        e = Uu(n, p, r),
        v = Jo({ beforeResize: Yo(['table']), afterResize: Yo(['table']), startDrag: Yo([]) });
      return (
    ...
    Ni = function (n, e) {
      var t,
        ...
        i = Go(Ti),
        c = ki(n, e);
      (r = i), (o = c), (u = xo((t = e))), qo(t, S.some(u), S.none(), r, o), Ei(t);
    },
    _i = function (n, e) {
      var t = Go(Ti),
        r = ki(n, e);
            ...
            o.on(),
              ...
              o.events.beforeResize.bind(function (n) {
                ...
                (e = c),
                  (r = pi((t = u))),
                  (o = hi(u)),
                  e.fire('ObjectResizeStart', { target: t, width: r, height: o });
              }),
    ...
    Ki = function (t, r) {
      vo(t)
        .bind(function (n) {
          var e = co.exec(n);
          return null !== e ? S.some({ width: b(parseFloat(e[1])), unit: b(e[3]) }) : S.none();
        })
        .each(function (n) {
          var e = n.width() / 2;
          ...
          .fold(
            ...
            function (n) {
              ...
              return (
                ...
                s(o),
                Fu(r, o, Yr, i),
                S.some({ cursor: n.cursor, newRows: b(e.newRows), newCells: b(e.newCells) })
              );
            },
          );
      };
    ...
    Bc = function (n, l, f, s, d) {
      return k(n, function (n) {
        var e,
          ...
          i,
          c,
          a = 0 < l && l < tc(n) && s(ec(n, l - 1), ec(n, l)) ? nc(n, l) : je(d(ec(n, f), s), !0);
        return (
          (t = l),
          (r = a),
          (o = (e = n).cells()),
    ...
    Wc = function (r, o) {
      ...
      var t = Ri(S.none()),
        ...
        i = function (n) {
          var e = u(n);
          return t.get().isNone() && t.set(S.some(e)), (c = S.some({ item: n, replacement: e })), e;
        },
        c = S.none();
      return {
      ...
      return function (r) {
        ...
        var u = [],
          i = function (n) {
            var e = { scope: c },
              t = r.replace(n, a, e);
            return u.push({ item: n, sub: t }), o.get().isNone() && o.set(S.some(t)), t;
          };
        return {
        ...
        function (n, e, t, r) {
          ...
          var u = (function (n, e, t) {
            ...
            for (var r = e.startRow(); r <= e.finishRow(); r++)
              for (var o = e.startCol(); o <= e.finishCol(); o++) Ji(n[r], o, je(t(), !1));
            return n;
          })(n, e.bounds(), b(o[0]));
          ...
          .map(function (n) {
            ...
            return (
              li(o)
                ...
                : fi(o)
                ? Wi(n)
                : (ai(o) || ((e = u.width), m(e) && -1 !== e.indexOf('%'))) && Ni(o, n),
              wi(n),
              mn(n, 'data-mce-id'),
              (t = o),
      ...
      return mc(o, e).map(function (n) {
        ...
        return k(t, function (n) {
          ...
          return (
            E(n.cells(), function (n) {
              var e = Dt(n.element());
              Gi(e, 'colspan', n.colspan(), 1), Gi(e, 'rowspan', n.rowspan(), 1), Be(t, e);
            }),
            t
          );
        });
    ...
    el = function (n) {
      return (
        0 < (e = Ua(n.getParam('table_cell_class_list', [], 'array'))).length
    ...
    ol = function (d, n, m) {
      ...
      E(n, function (n) {
        ...
        (t = m),
          ...
          m.valign && ((c = d), (a = f), (l = m.valign) && c.formatter.apply('valign' + l, {}, a));
      });
    },
    ul = function (n, e, t) {
      var r = t.getData();
    ...
    il = function (u) {
      ...
      if (0 !== n.length) {
        var e = k(n, function (n) {
          ...
          r = {
            type: 'tabpanel',
            tabs: [{ title: 'General', name: 'general', items: el(u) }, Ga('cell')],
          },
          o = { type: 'panel', items: [{ type: 'grid', columns: 2, items: el(u) }] };
    ...
    al = function (n) {
      return (
        0 < (e = Ua(n.getParam('table_row_class_list', [], 'array'))).length
          ? S.some({ name: 'class', type: 'selectbox', label: 'Class', items: e })
          : S.none()
      ).fold(
        function () {
    ...
    sl = function (u) {
      ...
      if (0 !== n.length) {
        var e = k(n, function (n) {
          ...
          r = {
            type: 'tabpanel',
            tabs: [{ title: 'General', name: 'general', items: al(u) }, Ga('row')],
          },
          o = { type: 'panel', items: [{ type: 'grid', columns: 2, items: al(u) }] };
        u.windowManager.open({
    ...
    ml = function (n, e, t, r) {
      if ('TD' === e.tagName || 'TH' === e.tagName) m(t) ? n.setStyle(e, t, r) : n.setStyle(e, t);
      else if (e.children) for (var o = 0; o < e.children.length; o++) ml(n, e.children[o], t, r);
    },
    gl = function (t, r, n) {
      var o,
        u = t.dom,
          ...
          !(function (n, e, t) {
            ...
            if (
              ...
              o.getAttrib(e, 'width') && !ci(n)
                ...
                : (i.width = bi(t.width)),
              ci(n)
                ? ((i['border-width'] = bi(t.border)), (i['border-spacing'] = bi(t.cellspacing)))
                : ((u.border = t.border),
              ...
              for (var c = 0; c < e.children.length; c++)
                ml(o, e.children[c], { 'border-width': bi(t.border), padding: bi(t.cellpadding) }),
                  ii(n) && ml(o, e.children[c], { 'border-color': t.bordercolor });
            ii(n) &&
            ...
            !o &&
              i.caption &&
              (((o = u.create('caption')).innerHTML = dl.ie ? '\xa0' : '<br data-mce-bogus="1"/>'),
    ...
    pl = function (n, e) {
      ...
      !1 === e
        ? (t = f.getParent(n.selection.getStart(), 'table'))
          ...
          : ii(n) && ((s.borderstyle = ''), (s.bordercolor = ''), (s.backgroundcolor = ''))
        : ((s.cols = '1'),
          (s.rows = '1'),
          ii(n) && ((s.borderstyle = ''), (s.bordercolor = ''), (s.backgroundcolor = '')));
      ...
      var m,
        ...
        v = {
          ...
          items:
            ...
            (p = n.getParam('table_appearance_options', !0, 'boolean')
              ...
              : []),
            (h =
              0 < m.length ? [{ type: 'selectbox', name: 'class', label: 'Class', items: m }] : []),
            g
              .concat([
        ...
        b = ii(n)
          ? {
              type: 'tabpanel',
              tabs: [{ title: 'General', name: 'general', items: [v] }, Ga('table')],
            }
          : { type: 'panel', items: [v] };
    ...
    hl = function (a, t, l, f, e) {
              ...
              return o(u).each(function (e) {
                var n,
                  ...
                  o =
                    ((n = i),
                    (t = r),
                    { selection: b(Sr(u, f)), clipboard: b(n), generators: b(t) });
      ...
      K(
        ...
        K(
          { mceTableProps: y(pl, a, !1), mceTableRowProps: y(sl, a), mceTableCellProps: y(il, a) },
          function (n, e) {
    ...
    Wl = function (n, e, t, r) {
      return rn(e)
        ...
        : ((u = e),
          ...
          q(l, function (n) {
            return (
              a.selectNode(n.dom()), Nl(a.getBoundingClientRect(), i, c) ? Wl(o, n, i, c) : S.none()
            );
          }));
      var o, u, i, c, a, l;
    },
    ...
    ql = document.caretPositionFromPoint
      ...
      : function (o, u, e) {
          return Sn.fromPoint(o, u, e).bind(function (r) {
            var n = function () {
              return (n = o), (t = u), (0 === ae((e = r)).length ? Ll : Fl)(n, e, t);
              var n, e, t;
            };
    ...
    vf = function (t, n, r, e, o) {
      return Zn(r, e)
        ...
        : nr(r, e, n).bind(function (n) {
            var e = n.boxes.getOr([]);
            return 0 < e.length
              ? (o(t, e, n.start, n.finish), S.some(mf(S.some(hf(r, 0, r, wt(r))), !0)))
              : S.none();
          });
    },
    bf = function (n, e) {
      ...
      return u.getSelection().bind(function (o) {
        return Lf(i, o.finish(), o.foffset(), c).fold(
          ...
          function (n) {
            var e,
              t = u.fromSitus(n),
              r = Nf.verify(u, o.finish(), o.foffset(), t.finish(), t.foffset(), c.failure, i);
            return (
              (e = r),
              Nf.cata(
                e,
                ...
                return function () {
                  return q(n, function (n) {
                    return (
                      ...
                      (t = n.cols),
                      (r = g),
                      rr(u, e, t, (o = h).firstSelectedSelector, o.lastSelectedSelector).map(
                        function (n) {
                          return (
                    ...
                    function () {
                      return tr(g, h.firstSelectedSelector, h.lastSelectedSelector).map(function (
                        n,
                      ) {
                        var e = vs(c) || i.isForward(c) ? Tl.after : Tl.before;
                        return (
                          l.setRelativeSelection(Tl.on(n.first(), 0), e(n.table())),
                          h.clear(g),
                          mf(S.none(), !0)
                        );
                      });
            ...
            (a = Ri(0)),
            {
              touchEnd: function (n) {
                ...
                if ('td' === Q(e) || 'th' === Q(e)) {
                  var t = i.get(),
                    r = a.get();
                  Zn(t, e) && n.timeStamp - r < 300 && (n.preventDefault(), u(e, e));
                }
