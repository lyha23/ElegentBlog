...
!(function () {
      ...
      : ((Sr =
        ...
        (Nr.all = function () {
          var s = Array.prototype.slice.call(
            1 === arguments.length && Sr(arguments[0]) ? arguments[0] : arguments,
          );
  ...
  var Gr,
    ...
    wo = function (e) {
      var t = e.container();
      return (
        !!In(t) && (t.data.charAt(e.offset()) === fo || (e.isAtStart() && yo(t.previousSibling)))
      );
    },
    xo = function (e) {
      var t = e.container();
      return (
        !!In(t) && (t.data.charAt(e.offset() - 1) === fo || (e.isAtEnd() && yo(t.nextSibling)))
      );
    },
    So = function (e, t, n) {
      var r,
    ...
    jo = function (e, t) {
      return (
        (Lo(e) && !1 === ((o = t), In((r = e)) && Uo(r.data) && !1 === zo(r, o))) ||
        (An((n = e)) &&
          'A' === n.nodeName &&
          !n.hasAttribute('href') &&
    ...
    Yo = function (e, t, n) {
      ...
      return (
        !An(t) ||
          (1 === (o = t.childNodes).length && Ko(o[0]) && t.parentNode.insertBefore(o[0], t)),
        Un((a = t)) ||
          Fn(a) ||
          jo(t, r) ||
      ...
      e = function (e, t, n) {
        ...
        return (
          r
            ...
            : (r = li[e]) ||
              ((r = di(t, ' ', di(t.toUpperCase(), ' '))), (r = pi(r, n)), (li[e] = r)),
          r
        );
      },
      n = yi((i = i || {}).schema);
    ...
    var E = function (e) {
      ...
      b = function (e) {
        ...
        if (e) {
          var x = vi(e, ',');
          for (
            S['@'] && ((h = S['@'].attributes), (v = S['@'].attributesOrder)), t = 0, n = x.length;
            t < n;
            t++
          )
            if ((i = b.exec(x[t]))) {
          ...
          if (e) {
            for (
              ...
              if (
                ...
                if (((n = v(n)), (r = v(r)), -1 !== n.indexOf(E) || -1 !== n.indexOf('"')))
                  continue;
                if (
                  !b.allow_script_urls &&
                ...
                if (t)
                  for (r = l.length; r--; )
                    l[r].func === t &&
                      ...
                      (i[o] = l));
                (t && 0 !== l.length) ||
                  (delete i[o], Ai(n, l.fakeName || o, l.nativeHandler, l.capture));
              }
          } else
            ue(i, function (e, t) {
  ...
  var Ta = function (e, t, n, r) {
    ...
    if (
      ((t ? t.ownerDocument || t : Gi) !== Vi && Hi(t), (n = n || []), !e || 'string' != typeof e)
    )
      return n;
      ...
      function (e, t, n, r) {
        ...
        if (((n = n || []), 1 === l.length)) {
          ...
          for (
            ...
            if (
              (s = Bi.find[u]) &&
              (r = s(a.matches[0].replace(Aa, Ra), (ka.test(i[0].type) && La(t.parentNode)) || t))
            ) {
    ...
    function (r, o) {
      au.fn[r] = function (t) {
        ...
        this.each(function () {
          ...
          1 < this.length &&
            (Ka[r] || (n = hu.unique(n)), 0 === r.indexOf('parents') && (n = n.reverse()));
        var e = hu(n);
  ...
  var Fu,
    ...
    as = function (e, t) {
      var n,
        ...
        a =
          ((n = t), ((r = (o || document).createElement('div')).innerHTML = n), Gt(At.fromDom(r)));
      dn(i, a), mn(e), fn(e, i);
    },
    us = function (e, t) {
    ...
    js = function (e) {
      var t,
        ...
        i = function (e, t) {
          ...
          if (t < e.data.length) {
            ...
            if (Ss(e.data[t - 1]) && (n.setStart(e, t), n.setEnd(e, t + 1), !Ms(n)))
      ...
      if (Ns(e.container()))
        if (e.isAtEnd())
          ...
          if (((n = Bs(e.container(), e.offset())), Ts(n) && i(n, 0), As(n) && e.isAtEnd()))
            return o(zs(Us(n), !1)), r;
  ...
  var Vs,
    ...
    Ic = function (e, t) {
      return Tc(e) && t.container() === e
        ? ((r = t),
          ...
          0 < (o.text + i.text).length ? (Bc(n), $s(n, r.offset() - o.count)) : r)
        : Pc(e, t);
      var n, r, o, i;
    },
    Mc = function (e, t) {
    ...
    qc = function (e, i, a, t) {
      var n,
        ...
        l = function () {
          !(function (e) {
            for (
              var t = Gu(At.fromDom(e), '*[contentEditable=false],video,audio,embed,object'), n = 0;
              n < t.length;
              n++
            ) {
              var r,
    ...
    ll = function (e, t, n) {
      ...
      if (vo(u)) {
        if (
          (Zc(u) || (u = u.parentNode),
          'before' === (o = u.getAttribute('data-mce-caret')) && ((r = u.nextSibling), Kc(r)))
        )
          return sl(r);
  ...
  var hl,
    ...
    kl = function (e, t, n) {
      ...
      if (t.isEqual($s.after(n)) && n.lastChild) {
        if (((a = $s.after(n.lastChild)), e < 0 && wl(n.lastChild) && bl(n.lastChild)))
    ...
    Dl = function (e, t, n) {
      return e
        ? !Tl(t, n) && ((r = t), !(!$s.isTextPosition(r) && zn(r.getNode()))) && Rl(t) && Al(n)
        : !Tl(n, t) && Al(t) && Rl(n);
      var r;
    },
    Ol = function (e, t, n) {
    ...
    Ll = function (e, t) {
      ...
      return In(u)
        ...
        ? Lo(u)
          ...
          : ((r = t), (o = u), (i = (n = e) ? $s.before(o) : $s.after(o)), Ol(n, r, i))
        : U.none();
    },
    Il = N(Ol, !0),
    Ml = N(Ol, !1),
      ...
      if (
        ...
        for (
          u < (i = s.childNodes).length
            ...
            : ((s = i[i.length - 1]), (r = new Xr(s, e.getParent(s, e.isBlock))).next(!0)),
            o = r.current();
          o;
          o = r.next()
        )
    ...
    Tf = function (e, t, n, r, o) {
      ...
      for (;;) {
        ...
        for (i = u[s]; i; i = i[s]) {
          ...
          if (
            !yf(i) &&
            (!zn((a = i)) || !a.getAttribute('data-mce-bogus') || a.nextSibling) &&
            !Cf(i, l)
          )
            return u;
        }
    ...
    Of = function (e, t, n, r) {
      ...
      return (
        ...
        An(a) &&
          a.hasChildNodes() &&
          ((a = ws(a, t.collapsed ? u : u - 1)), In(a) && (u = a.nodeValue.length)),
        (o = xf(s, o)),
        (a = xf(s, a)),
        Df(o) &&
        ...
        n[0].selector &&
          !1 !== n[0].expand &&
          !n[0].inline &&
          ((o = _f(s, n, t, o, 'previousSibling')), (a = _f(s, n, t, a, 'nextSibling'))),
        (n[0].block || n[0].selector) &&
          ((o = Af(e, n, o, 'previousSibling')),
          (a = Af(e, n, a, 'nextSibling')),
          n[0].block &&
            (s.isBlock(o) || (o = Tf(s, n, o, i, !0)), s.isBlock(a) || (a = Tf(s, n, a, u, !1)))),
  ...
  var rd,
        ...
        L = function (e) {
          ...
          (w = s * p[2] + v),
            ...
            (D(f) && !1 !== l.getParam('resize_img_proportional', !0, 'boolean')
              ...
              : ud.modifierPressed(e)) &&
              (_(s) > _(c) ? ((x = A(w * b)), (w = A(x / b))) : ((w = A(x / b)), (x = A(w * b)))),
            P(d, w, x),
        ...
        I = function () {
          ...
          e && (a('width', w), a('height', x)),
            ...
            e &&
              ...
              (o = x),
              (i = 'corner-' + p.name),
              t.fire('ObjectResized', { target: n, width: r, height: o, origin: i }),
    ...
    vd = function (e, t, n, r) {
      ...
      if (
        (An(l) && f > l.childNodes.length - 1 && (p = !1), Fn(l) && ((l = s), (f = 0)), l === s)
      ) {
      ...
      return (
        t === r && In(t)
          ? 0 < n &&
            ...
            n < o
              ? ((t = r = bd(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0))
              : (o = 0))
          : (In(t) && 0 < n && n < t.nodeValue.length && ((t = bd(t, n)), (n = 0)),
            In(r) &&
              0 < o &&
  ...
  var Sd,
    ...
    Gd = function (e) {
      return (
        void 0 === e && (e = At.fromDom(document)), U.from(e.dom.activeElement).map(At.fromDom)
      );
    },
    Jd = function (e, t, n, r) {
    ...
    Cm = function (t, e) {
      return (
        (n = e).collapsed ? U.from(ws(n.startContainer, n.startOffset)).map(At.fromDom) : U.none()
      ).bind(function (e) {
        ...
        if ('undefined' == typeof c.length) {
          for (a in c)
            if (c.hasOwnProperty(a)) {
              if (((u = 'attributes' === r ? e.getAttrib(t, a) : ff(e, t, a)), o && !u && !n.exact))
                return;
          ...
          var m = function (e) {
            ...
            if (l) l(e);
              ...
              if (
                ...
                (n = e.shortEnded),
                (r = e.attributes),
                f && r && 1 < r.length && (((a = []).map = {}), (c = p.getElementRule(e.name))))
              ) {
  ...
  var rp,
      ...
      return U.some(e)
        ...
        .bind(function (e) {
          ...
          !(!tg(u, 0) || eg(i, s) || ((a.data = ' ' + u.slice(1)), 0)) ||
            ...
            (r = (n = c).data),
            (o = Hs(n, r.length - 1)),
            !(!tg(r, r.length - 1) || eg(t, o) || ((n.data = r.slice(0, -1) + ' '), 0))))
            ? U.some(e)
            : U.none();
        });
    },
    ...
    cg = function (e, t, n, r) {
      ...
      var o = Ke(e.data).length,
        ...
        a = r ? t : e;
      return (
        r ? i.appendData(a.data) : i.insertData(0, a.data), pn(At.fromDom(a)), n && ug(i, o), i
      );
    },
    lg = function (e, t) {
      return (
        ...
        (o = (n = t).container()),
        (i = n.offset()),
        !1 === $s.isTextPosition(n) && o === r.parentNode && i > $s.before(r).offset()
    ...
    fg = function (e) {
      return Lo(e.previousSibling)
        ? U.some(((t = e.previousSibling), In(t) ? $s(t, t.data.length) : $s.after(t)))
        : e.previousSibling
    ...
    Pg = function (e, t) {
      var n,
        ...
        s =
          ((o = u), (i = Sg((r = t).startContainer, o)), (a = Sg(r.endContainer, o)), ds(i, a, wg));
      return Og(s, t, u)
        .map(function (e) {
    ...
    ih = function (e) {
      ...
      (r = t),
        (o = n),
        null !== (i = a) && i === r.getParent(o.endContainer, oh) && jf(At.fromDom(i), o)
          ? Mg(e, n, At.fromDom(a))
    ...
    ah = function (e, t, n) {
      ...
      if ((y = e.fire('BeforeSetContent', y)).isDefaultPrevented())
        ...
        if (!0 === n.paste && Jg(e.schema, F) && eh(m, r))
          return (a = rh(h, m, d.getRng(), F)), d.setRng(a), void e.fire('SetContent', y);
        if (
          (!(function (e) {
            ...
            : ((t = u),
              ...
              0 === (r = s).length || /^\s+$/.test(r)
                ? ((a = '<br data-mce-bogus="1">'),
                  ...
                  (r =
                    (i = vc(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase())
    ...
    vh = function (e) {
      ...
      return (
        Yn(t, { id: ph, 'data-mce-bogus': '1', 'data-mce-type': 'format-caret' }),
  ...
  var Ah = kt.each,
    ...
    jh = function (e, t, n) {
      ...
      return (
        An(o) && ((r = o.childNodes.length - 1), !n && i && i--, (o = o.childNodes[r < i ? r : i])),
                ...
                ((m.list_block && Uh(d, m.list_block)) ||
                  W(oe(d.childNodes), function (e) {
                    af(f, v, e.nodeName.toLowerCase())
                      ? p
                        ? p.appendChild(e)
                        : ((p = Vh(h, e, v)), h.setAttribs(p, f.settings.forced_root_block_attrs))
                      : (p = 0);
                  }))
              : h.isBlock(d) &&
                !h.isBlock(g) &&
    ...
    Xh = function (e, t, n, r, o, i, a, u) {
      ...
      if (n) {
        ...
        !i || (a.mixed && f.isBlock(n)) || (r = f.split(n, r)),
          c && (o.parentNode.insertBefore(c, o), l.appendChild(o), a.inline && Oh(f, a, 0, c));
      }
      return r;
    },
          ...
          if (m.split) {
            if (((r = Cd(r)), (t = jh(s, r, !0)) !== (n = jh(s, r)))) {
              if (((t = Hh(t, !0)), (n = Hh(n, !1)), zh(a, t, n))) {
                ...
                return (
                  u(qh(a, o, !0, 'span', { id: '_start', 'data-mce-type': 'bookmark' })), void g(!0)
                );
              }
              if (zh(a, n, t)) {
              ...
              (t = Vh(a, t, 'span', { id: '_start', 'data-mce-type': 'bookmark' })),
                (n = Vh(a, n, 'span', { id: '_end', 'data-mce-type': 'bookmark' }));
              var i = a.createRng();
              i.setStartAfter(t),
                i.setEndBefore(n),
                Pf(a, i, function (e) {
          ...
          return (
            ...
            (Qh(e, function (e) {
              if (!('collapsed' in e && e.collapsed !== i))
                return a.is(t, e.selector) && !jl(t) ? (T(t, e), !(n = !0)) : void 0;
            }),
            n)
          );
        },
                ...
                s = function (e) {
                  ...
                  if (R.wrapper && zm(E, e, k, _)) u = null;
                    ...
                    (Zh(R, 'inline') && S.isBlock(e))
                      ? ((u = null), Qh(kt.grep(e.childNodes), s), t && (l = n), (u = null))
      ...
      if ('false' !== a.getContentEditable(u.getNode())) {
        R &&
          (r
            ? tf(r)
              ? m(A, r) ||
                ((e = a.createRng()).setStartBefore(r), e.setEndAfter(r), s(a, Of(E, e, A), 0, !0))
              : s(a, r, 0, !0)
            : i && vf(R) && !Ff(E).length
            ? (function (e, t, n) {
                var r,
      ...
      return (
        W(Gu(e, 'tr'), function (n, r) {
          W(Gu(n, 'td,th'), function (e, t) {
            !(function (e, t, n, r, o) {
              for (
                var i = uv(o, 'rowspan'), a = uv(o, 'colspan'), u = e.rows, s = n;
                s < n + i;
                s++
              ) {
                u[s] || (u[s] = av(cs(r), []));
    ...
    Sv = function (e, t, n) {
      ...
      var r,
        ...
        l =
          ...
          (s = Om(r, Lf(u))),
          (c = o.contextual ? bv(At.fromDom(r.getBody()), s).dom : i.cloneContents()) &&
            a.appendChild(c),
      ...
      return {
        undoManager: {
          ...
          hasUndo: function (e, t) {
            return (
              (n = f), (r = e), 0 < t.get() || (r.typing && r.data[0] && !Bv(Rv(n), r.data[0]))
            );
            var n, r;
          },
  ...
  var sy,
            ...
            for (var t, n, r, o = e.length; o--; ) {
              ('ul' !== (r = (n = e[o]).parent).name && 'ol' !== r.name) ||
                (n.prev && 'li' === n.prev.name
                  ? n.prev.append(n)
                  : ((t = new Km('li', 1)).attr('style', 'list-style-type: none'), n.wrap(t)));
            }
          }),
        g.validate &&
          h.getValidClasses() &&
              ...
              k = ip(
                {
                  ...
                  start: function (e, t, n) {
                    ...
                    if (a) {
                      ...
                      if ((S && y[e] && (S = !1), a.removeEmpty && dy(R, m, y, c)))
                        return (
                          (o = c.parent), d[c.name] ? c.empty().remove() : c.unwrap(), void (c = o)
                        );
                      a.paddEmpty &&
                        ((fy((i = c), '#text') && i.firstChild.value === lo) || dy(R, m, y, c)) &&
                        ly(A, u, d, c),
                        (c = c.parent);
                    }
                  },
    ...
    xy = function (e, t, n, r, o) {
      ...
      return (
        ...
        (u = o).no_events || !a
          ? s
          : ((c = a), (l = ke(ke({}, u), { content: s })), c.fire('PostProcess', l).content)
      );
    },
    Sy = function (y, b) {
    ...
    Vy = function (e, t, n, r) {
      return e && ((a = i = 'mobile'), (u = (o = t).sections()), jy(o, i) && u[i].theme === a)
        ? H(r, N(M, My))
        : e && jy(t, 'mobile')
        ? r
        : n;
        ...
        d = e
          ? {
              mobile:
                ((i = o.mobile || {}),
                (a = t),
                (u = { resize: !1, toolbar_mode: Hy(i, 'scrolling'), toolbar_sticky: !1 }),
    ...
    nb = function (e, t, n) {
      ...
      return (
        (l = h.x), (f = h.y), (d = Qy((c = g))), (m = Zy(c)), 0 <= l && 0 <= f && l <= d && f <= m
      );
    },
    rb = function (e) {
      var t,
    ...
    pb = function (t) {
      var e,
        ...
        r =
          ...
          q(n) ? z(n.split(','), $e) : S(n) ? n : !1 === n || e.inline ? [] : ['default']),
          ...
          return {
            fireIfChanged: function () {
              ...
              re(t)
                ...
                .each(function (e) {
                  n.setDirty(!0),
                    n.fire('change', { level: e, lastLevel: te(t, t.length - 2).getOrNull() });
                });
            },
          };
        })(s),
                          ...
                          e.status && s.getParam('images_replace_blob_uris', !0, 'boolean')
                            ...
                            : e.error &&
                              (e.error.options.remove &&
                                (v(i.getAttribute('src'), wt.transparentSrc), a.push(i)),
                              (n = s),
                              (r = e.error.message),
  ...
  var Cb,
          ...
          (t = e.replace(/(?:([#\.]|::?)([\w\-]+)|(\[)([^\]]+)\]?)/g, function (e, t, n, r, o) {
            switch (t) {
              ...
              case '.':
                ...
                break;
              case ':':
                -1 !== kt.inArray('checked disabled enabled read-only required'.split(' '), n) &&
                  (a.attrs[n] = n);
            }
            var i;
            return (
        ...
        l = function (e, t) {
          ...
          !(function (e) {
            if (Ob(e)) {
              var t = e.keyCode;
              return (
                !Bb(e) && (ud.metaKeyPressed(e) || e.altKey || (112 <= t && t <= 123) || M(Tb, t))
              );
            }
            return !1;
          })(e) &&
        ...
        e
          ? function (e) {
              if (kC(e.previousSibling))
                return AC(e.previousSibling) || e.previousSibling.appendData(fo), e.previousSibling;
          ...
          : function (e) {
              if (kC(e.nextSibling))
                return _C(e.nextSibling) || e.nextSibling.insertData(0, fo), e.nextSibling;
    ...
    JC = function (a, e, u, t, n, s) {
      return ds(Fb(e, u, t), Fb(e, u, n), function (e, t) {
        return e !== t && ((r = t), (o = rl(e, (n = u))), (i = rl(r, n)), o && o === i)
          ? MC.after(a ? e : t)
          : s;
        var n, r, o, i;
      }).getOr(s);
    ...
    nw = function (e, t) {
      ...
      return (
        ...
        (e && wo(r) ? tw(!0, t.selection, r) : !(e || !xo(r)) && tw(!1, t.selection, r))
      );
    },
    rw = function (e, t) {
      ...
      return (
        d.on('NodeChange', function (e) {
          ...
          !_c(d) ||
            ...
            (s = e.parents),
            (c = z(
              Gu(At.fromDom(u.getRoot()), '*[data-mce-selected="inline-boundary"]'),
              function (e) {
                return e.dom;
              },
            )),
      ...
      e.queryCommandState('InsertUnorderedList') ||
        ...
        W(kw(e), function (e) {
          ...
          (t = l),
            ...
            (s = Sw(r, At.fromDom(a))),
            'outdent' === n
              ? ((u = Math.max(0, xw(a.style[s]) - o)), t.setStyle(a, s, u ? u + i : ''))
    ...
    Lw = function (e, t) {
      ...
      t.hasAttribute('data-mce-caret') &&
        (ko(t), (n = e).selection.setRng(n.selection.getRng()), e.selection.scrollIntoView(t));
    },
    Iw = function (e, t) {
      var n,
        r =
  ...
  var Mw,
    ...
    zw = function (e, t, n, r) {
      for (
        ...
        f && ((s = l), (c = f), (o = t === Vs.Forwards ? s.next(c) : s.prev(c)));

      ) {
        if (zn(o.getNode(!1)))
          return t === Vs.Forwards
            ? { positions: Uw(t, d).concat([o]), breakType: Cb.Br, breakAt: U.some(o) }
  ...
  var Gw = function (o, i, a, e, u, t) {
        ...
        if (
          (u = ux(
            (function (e, r, t) {
              ...
              return (
                o.push(r), sx(Mw.Up, e, N(n, vs), r.node, t), sx(Mw.Down, e, N(n, ys), r.node, t), o
              );
            })(e, u, s),
            t,
          )) &&
    ...
    Tx = function (e, r) {
      return J(
        z(e, function (e) {
          return ke(
            { shiftKey: !1, altKey: !1, ctrlKey: !1, metaKey: !1, keyCode: 0, action: V },
            e,
          );
        }),
        function (e) {
    ...
    Hx = function (e, t, n) {
      ...
      return ((a = u).breakType === Cb.Wrap && 0 === a.positions.length) ||
        (!zn(n.getNode()) && (i = u).breakType === Cb.Br && 1 === i.positions.length)
        ? ((r = e),
          (o = t),
    ...
    aS = function (e, t, n, r, o) {
      ...
      n !== e.getBody() &&
        ...
        iS(n, r, !0) && iS(n, r, !1)
          ...
          : iS(n, r, !0)
          ? nS(n, 'LI')
            ? (f.insertAfter(a, oS(n)), a.appendChild(f.doc.createTextNode(' ')), a.appendChild(n))
          ...
          : ((n = oS(n)),
            ...
            u.setEndAfter(n),
            (s = u.extractContents()),
            'LI' === o && ((l = 'LI'), (c = s).firstChild && c.firstChild.nodeName === l)
    ...
    mS = function (a, e) {
      var t,
        ...
        h = function (e) {
          ...
          var o = new Xr(u, s);
          for (
            In(u) && (e && 0 === r ? o.prev() : e || r !== u.nodeValue.length || o.next());
            (t = o.current());
        ...
        v = function () {
          (n = /^(H[1-6]|PRE|FIGURE)$/.test(c) && 'HGROUP' !== C ? g(N) : g()),
            a.getParam('end_container_on_empty_block', !1) && cS(f, o) && f.isEmpty(s)
              ? (n = f.split(o, s))
              : f.insertAfter(n, s),
            eS(a, n);
        };
            ...
            vo(s)
              ...
              : ((S = (x = p).cloneRange()).setStart(
                ...
                (function (e) {
                  for (
                    ;
                    In(e) && (e.nodeValue = e.nodeValue.replace(/^[\r\n]+/, '')),
                      (e = e.firstChild);
  ...
  var JS = function (e) {
      ...
      return (
        ...
        function (g) {
          return e.on(function (e) {
            ...
            e.dragging &&
              ((d = e),
              (t = { pageX: (m = tN(h, g)).pageX - d.relX, pageY: m.pageY + 5 }),
              (l = e.ghost),
              (f = h.getBody()),
            ...
            var a = function (e) {
              ...
              i = function (e, t) {
                var n,
                  ...
                  i = l.getParent(t, f);
                return (
                  !(!o || e === i || !l.isChildOf(o, i) || !1 !== dN(mN(u, o))) ||
          ...
          u.on('dragstart', function (e) {
            ...
            (t = e).dataTransfer &&
              ...
              0 < (n = u.selection.getContent()).length &&
                ((r = m + escape(u.id) + ',' + escape(n)), t.dataTransfer.setData(p, r)));
          }),
          u.on('drop', function (e) {
            var t, n, r, o, i, a;
            h(e) ||
              ((t =
                (i = e).dataTransfer && (a = i.dataTransfer.getData(p)) && 0 <= a.indexOf(m)
    ...
    NN = function (e) {
      ...
      var n = gc(e, 'body_id', 'tinymce'),
        r = gc(e, 'body_class', '');
      return (
        hc(e) && (t += '<meta http-equiv="Content-Security-Policy" content="' + hc(e) + '" />'),
        (t +=
          '</head><body id="' +
          n +
    ...
    EN = function (e, t) {
      var n,
        ...
        u =
          ...
          (i = At.fromTag('iframe')),
          Yn(i, o),
          Yn(i, { id: n + '_ifr', frameBorder: '0', allowTransparency: 'true', title: r }),
      ...
      e.fire('ScriptsLoaded'),
        ...
        q(u)
          ? ((i.settings.theme = AN(u)),
            ...
            i.theme.init &&
              i.theme.init(i, ab.urls[u] || i.documentBaseUrl.replace(/\/$/, ''), i.$))
          : (i.theme = {}),
        (s = e),
        (c = []),
        ...
        ? t.getElement() &&
          ...
          (a = t.getElement().form || BN.getParent(e, 'form')) &&
            ...
            t.getParam('hidden_input') &&
              !Ln(t.getElement()) &&
              (BN.insertAfter(BN.create('input', { type: 'hidden', name: e }), e),
              (t.hasHiddenInput = !0)),
            ...
            u.preventDefault(),
              /^#/.test(e)
                ? (t = a.dom.select(
                    e +
                      ',[name="' +
                      (Ve((n = e), (r = '#')) ? ((o = n), (i = r.length), o.substring(i)) : n) +
                      '"]',
  ...
  var mE,
      ...
      toggleNativeEvent: function (e, t) {
        ...
        'focus' !== e &&
          ...
          (t
            ...
            : n.initialized && (n.dom.unbind(vE(n, e), e, n.delegates[e]), delete n.delegates[e]));
      },
    ...
    AE =
      ...
      (RE.prototype.createShortcut = function (e, t, n, r) {
        ...
        return (
          (o[o.length - 1] = kt.extend(o[o.length - 1], { func: n, scope: r || this.editor })),
  ...
  var ME = Eu.DOM,
    ...
    HE =
      ...
      (VE.prototype.hide = function () {
        ...
        e.hidden ||
          ...
          e.inline
            ...
            : (ME.hide(e.getContainer()), ME.setStyle(e.id, 'display', e.orgDisplay)),
          (e.hidden = !0),
          e.fire('hide'));
      }),
      ...
      (VE.prototype.resetContent = function (e) {
        e === undefined ? ky(this, this.startContent, { format: 'raw' }) : ky(this, e),
      ...
      (VE.prototype.getContainer = function () {
        return (
          this.container || (this.container = ME.get(this.editorContainer || this.id + '_parent')),
          this.container
        );
      }),
  ...
  var qE,
    ...
    ek = function (e) {
      e !== GE &&
        (e ? hu(window).on('resize scroll', ZE) : hu(window).off('resize scroll', ZE), (GE = e));
    },
    tk = function (t) {
      var e = QE;
      delete JE[t.id];
