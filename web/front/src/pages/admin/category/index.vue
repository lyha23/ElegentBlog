    ...
    <el-table rowKey="id" :data="Catelist" @change="handleTableChange">
      ...
      <el-table-column label="操作">
        <template #default="scope">
          <el-button type=" primary" icon="edit" style="margin-right: 15px" @click="editCate(data)"
            >编辑</el-button
          >
          <el-button
            type="danger"
  ...
  >
    ...
    <template #footer>
      <div class="dialog-footer">
        ...
        <el-button type="primary" @click="addCateOk"> OK </el-button>
      </div>
    </template>
  </el-dialog>
  ...
  >
    ...
    <template #footer>
      <div class="dialog-footer">
        ...
        <el-button type="primary" @click="editCateOk"> OK </el-button>
      </div>
    </template>
  </el-dialog>
</template>
